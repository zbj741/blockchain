...
import com.buaa.blockchain.vm.program.Stack;
import com.buaa.blockchain.vm.program.exception.ExceptionFactory;
import com.buaa.blockchain.vm.program.exception.ReturnDataCopyIllegalBoundsException;
import com.buaa.blockchain.vm.program.exception.StaticCallModificationException;
...
import static com.buaa.blockchain.vm.OpCode.*;
import static com.buaa.blockchain.vm.utils.ByteArrayUtil.EMPTY_BYTE_ARRAY;
import static com.buaa.blockchain.vm.utils.VMUtil.getSizeInWords;
...
public class VM {
    ...
    private long calcMemGas(GasTable feeSchedule, long oldMemSize, BigInteger newMemSize, long copySize) {
        long gasCost = 0;
...
//                    }
            ...
            GasTable feeSchedule = spec.getGasTable();
