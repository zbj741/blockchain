package com.buaa.blockchain.crypto.utils;


import com.buaa.blockchain.crypto.utils.exceptions.MessageDecodingException;
import com.buaa.blockchain.crypto.utils.exceptions.MessageEncodingException;
...
public final class Numeric {
    ...
    public static boolean containsHexPrefix(String input) {
        return !com.buaa.blockchain.crypto.utils.StringUtils.isEmpty(input)
                && input.length() > 1
                && input.charAt(0) == '0'
                && input.charAt(1) == 'x';
    }
    ...
    public static String toHexStringNoPrefix(byte[] input) {
        return com.buaa.blockchain.crypto.utils.Hex.toHexString(input);
    }
    ...
    public static String toHexStringWithPrefixSafe(BigInteger value) {
        ...
        if (result.length() < 2) {
            result = com.buaa.blockchain.crypto.utils.StringUtils.zeros(1) + result;
        }
    ...
    private static String toHexStringZeroPadded(BigInteger value, int size, boolean withPrefix) {
        ...
        if (length < size) {
            result = com.buaa.blockchain.crypto.utils.StringUtils.zeros(size - length) + result;
        }
    ...
    public static String toHexString(byte[] input) {
        ...
        stringBuilder.append("0x").append(com.buaa.blockchain.crypto.utils.Hex.toHexString(input));
