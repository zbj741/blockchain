...
import static com.buaa.blockchain.crypto.CodingUtils.hexStringToBytes;
...
public class RSAUtils {
    ...
    /**
     * RSA公钥加密
     * @param Scontent 等待加密的数据
     * @param publicKey RSA 公钥 if null then getPublicKey()
     * @return 加密后的密文(16进制的字符串)
     */
    public static String encryptByPublic(String Scontent,PublicKey publicKey){
        ...
        try {
            ...
            for (byte[] array : arrays){
                ...
                //stringBuffer.append(Base64Utils.encode(cipher.doFinal(array)));
     ...
     * @return 加密后的密文(16进制的字符串)
     */
    public static String encryptByPrivate(String Scontent,PrivateKey privateKey){
        byte[] content = Scontent.getBytes();
        if (privateKey == null){
